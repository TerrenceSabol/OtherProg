...
namespace ImportFromFireEngineRed
{
    static class Program
    {
        ...
        public static string[,] ColumnIndex = { 
            ...
            {"Personal Statement_Copy/Paste","445"},
        ...
        /// <summary>
        /// Allow system paint updates to occur/ etc
        /// </summary>
        /// <param name="ms"></param>
        ...
        /// </summary>
        /// <returns>Next available Jenzabar ID Number</returns>
        ...
        /// <summary>
        /// Gets Jenzabar ID of high school from CEEB code
        /// </summary>
        /// <param name="strCEEB"></param>
        /// <returns></returns>
        public static string GetHSCodeFromCEEB(string strCEEB)
        {
            string theAnswer;
            try
            {
                SqlConnection cn = new SqlConnection("Data Source=" + DatabaseHostname + ";Initial Catalog=" + DatabaseCatalog + ";User Id=" + DatabaseUsername + ";Password=" + DatabasePassword + ";");
                string sqlQuery = "SELECT [ID_NUM] FROM [ORG_MASTER] WHERE [ORG_CDE] = '" + strCEEB + "' AND [ORG_TYPE] = 'HS'";
                SqlCommand cmd = new SqlCommand(sqlQuery, cn);
                cn.Open();
                theAnswer = cmd.ExecuteScalar().ToString();
                cn.Close();
    ...
    {
        /// <summary>
        /// Similar to ReadLine(), but only stops at newlines that are NOT encapsulated in quotes
        /// </summary>
        /// <param name="sr"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Get count of occurences of strSearchString in this string
        /// </summary>
        /// <param name="s"></param>
        ...
        /// <summary>
        /// If calling string is null, use the supplied string
        /// </summary>
        /// <param name="s"></param>
