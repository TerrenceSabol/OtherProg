...
Public Class Form1
    ...
    Private Sub ListBox3_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListBox3.SelectedIndexChanged
        Dim theitem As String
        theitem = ListBox3.SelectedItem.ToString
        Dim ok As Boolean
    End Sub
    ...
    Private Sub CheckBox2_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox2.CheckedChanged
        If CheckBox2.Checked = True Then
            Try
                ...
                oODBCConnection.Open()
                strSQL = "update  dbo.NC_CONTROL_INFO set CTLFLD1='" & Trim(TextBox3.Text) & "'   where CTLNAME='EMAIL_NAME' and CTLFLD2='QUICKEMAIL' and CTLFLD3='0'"
    ...
    Private Sub CheckBox3_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox3.CheckedChanged
        If CheckBox3.Checked = True Then
            Try
                ...
                oODBCConnection = New Odbc.OdbcConnection(sConnString)
                oODBCConnection.Open()
                strSQL = "update  dbo.NC_CONTROL_INFO set Ctlfld1='" & Trim(TextBox4.Text) & "'   where CTLNAME='EMAIL_ADDRESS' and CTLFLD2='QUICKEMAIL' and CTLFLD3='0'"
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        Try
            ...
            strSQL = "Select a.ID_NUM, sum(a.trans_amt)   ,Coalesce(last_name + ' '  + middle_name + '  ' +  first_name, last_name  + ' '  + first_name, last_name),  email_address   from trans_hist a left join name_master nm on a.id_num=nm.id_num   where SUBSID_CDE='AR'   and                         TRANS_DTE"
            strSQL += " between '" & TextBox6.Text & "' and '" & TextBox7.Text & "'   group by a.id_num,Coalesce(last_name + ' '  + middle_name + '  ' +  first_name, last_name  + ' '  + first_name, last_name),  email_address having sum(trans_amt) < ( select ctlfld1 from NC_CONTROL_INFO where ctlname='BILLING_DEBIT_AMOUNT')"
            strSQL += " OR sum(trans_amt) > ( select ctlfld1 from NC_CONTROL_INFO where ctlname='BILLING_CREDIT_AMOUNT')"
            strSQL += "  order by Coalesce(last_name + ' '  + middle_name + '  ' +  first_name, last_name  + ' '  + first_name, last_name)"
