...
Public Class Form1
    ...
    Private Function FetchData() As DataTable
        ...
        Using Conn As New Data.SqlClient.SqlConnection("Data Source=NCSQL1;Initial Catalog=tmseply;timeout=60; User Id=sa;Password=jenzadmin;"), Command As New Data.SqlClient.SqlCommand("SELECT distinct * from NC_control_info     order by ctlname,ctlfld2,ctlfld3    ", Conn), sAdapter As New Data.SqlClient.SqlDataAdapter(Command)
    ...
    Private Function FetchNames() As DataTable
        ...
        Using Conn As New Data.SqlClient.SqlConnection("Data Source=NCSQL1;Initial Catalog=tmseply;timeout=60; User Id=sa;Password=jenzadmin;"), Command As New Data.SqlClient.SqlCommand("SELECT distinct ctlname from NC_control_info     order by ctlname     ", Conn), sAdapter As New Data.SqlClient.SqlDataAdapter(Command)
