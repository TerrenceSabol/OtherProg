...
Public Class Form1
    ...
    Function Processh1() As Boolean
        ...
        strSQL2 += "  (divmastadv is Null or advstud is null or advmast is null or majorcde is null)   "
        ...
        Label1.Text = "Advisors were successfully generated for " & CStr(thecount) & " Incoming Students"
